...
l_pool_shared1 = AveragePooling1D(7, strides=2)
...
#l_conv_shared2 = Conv1D(128, 5, activation='relu', strides=1)
...
#l_pool_shared2 = AveragePooling1D(5, strides=1)
...
from keras.layers import Dense, Flatten, Activation, RepeatVector, Permute, merge

#left attention layer
left_activations_weights = Dense(1, activation='tanh')(left_lstm)
left_activations_weights = Flatten()(left_activations_weights)
left_activations_weights = Activation('softmax')(left_activations_weights)
left_activations_weights = RepeatVector(50)(left_activations_weights)
left_activations_weights = Permute([2, 1])(left_activations_weights)

#right attention layer
right_activations_weights = Dense(1, activation='tanh')(right_lstm)
right_activations_weights = Flatten()(right_activations_weights)
right_activations_weights = Activation('softmax')(right_activations_weights)
right_activations_weights = RepeatVector(50)(right_activations_weights)
right_activations_weights = Permute([2, 1])(right_activations_weights)


# In[ ]:


print(left_activations_weights.shape)


# In[ ]:


left_output = merge([left_lstm, left_activations_weights], mode='mul')
right_output = merge([right_lstm, right_activations_weights], mode='mul')
